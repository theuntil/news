...
/* ---------------- COMPONENT ---------------- */
export default function MarketsMobileBar() {
...
function EmptyCard({ code }: { code: string }) {
  return (
    <div className="min-w-[140px] rounded-xl border border-neutral-100 px-3 py-2 opacity-40">
  ...
  return (
    <div className="flex gap-3 animate-pulse">
      {ORDER.map((c) => (
        <div
          key={c}
          className="min-w-[140px] rounded-xl border border-neutral-100 px-3 py-2"
        >
